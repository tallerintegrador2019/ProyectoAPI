...
{
    public class PublicacionABMController : Controller
    {
        ...
        // GET: PublicacionABM/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: PublicacionABM/Create
