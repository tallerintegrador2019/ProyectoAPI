...
namespace ProyectoAPI.Controllers
{
    public class PublicacionCRUDController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,titulo,descripcion,imagen")] Publicacion publicacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,titulo,descripcion,imagen")] Publicacion publicacion)
        {
            if (ModelState.IsValid)
            {
